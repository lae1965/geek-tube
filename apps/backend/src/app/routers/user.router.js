...
router.post('/registration', userValidation.create, (...args) =>
  userController.create(...args)
);
router.post('/login', userValidation.login, (...args) =>
...
router.get(
  '/activate/:link',
  userValidation.checkLink,
  userController.activate
);
router.get('/refresh', userValidation.refresh, (...args) =>
  userController.refresh(...args)
);
router.get(
  '/avatar/:id',
...
router.get(
  '/find_min/:id',
  userValidation.checkId,
  userController.getNickNameById
);
